...
from PyQt5.QtCore import QElapsedTimer, QFile, QIODevice, Qt, QTimer
from PyQt5.QtGui import (QImage, QMatrix4x4, QOpenGLBuffer, QOpenGLShader,
                         QOpenGLShaderProgram, QOpenGLTexture, QQuaternion,
...
class Window(QOpenGLWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("panda3d.bullet, OpenGL 3.3, PyQt5")
        self.resize(400, 400)
